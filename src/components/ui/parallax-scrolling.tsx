...
export function ParallaxComponent() {
  ...
  useEffect(() => {
    ...
    // Scoped to this component so cleanup never touches ScrollTriggers owned
    // by other components (the global footer in the root layout, for one).
    ...
    return () => {
      // Reverts only the tweens and ScrollTriggers created inside ctx.
      ctx.revert();
  ...
  return (
    <div className="parallax" ref={parallaxRef}>
      ...
      <section className="parallax__content">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 160 160" fill="none" className="parallax__icon">
